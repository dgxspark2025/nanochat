"""
Image categorization training using GPT model with 2x2 patches.
Run as:
...
def create_patch_classifier(num_classes=10, image_size=28, patch_size=2):
...
def train_patch_classifier():
    ...
    model = create_patch_classifier(num_classes=10, image_size=28, patch_size=2)
